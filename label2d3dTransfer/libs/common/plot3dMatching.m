...
function []=plot3dMatching(p1,p2,matchIdx)
if size(p1,1)==3
    p1 = p1';
end
if size(p2,1)==3
...
for i= 1:length(p1)
    ...
    Z = [p1(i,3);p2(matchIdx(i),3)];
    plot3(p1(i,1),p1(i,2),p1(i,3),'sr','Markersize', 8);
    plot3(p2(matchIdx(i),1),p2(matchIdx(i),2),p2(matchIdx(i),3),'sb','Markersize', 8);
